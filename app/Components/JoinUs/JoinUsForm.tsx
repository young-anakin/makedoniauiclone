...
const JoinUsForm = () => {
  ...
  return (
    ...
    <div className='flex w-[1100px] bg-white  gap-5 shadow-lg'>
    <div className='flex flex-col pr-12 pl-12  py-12 w-3/5 '>
        <div className="flex w-[600px] mr-11">
                ...
                >
                    ...
                    <p className='text-red-500 text-lg font-sans font-medium'> WE KINDLY INVITE YOU TO JOIN US</p>
                    </div>
                    <p className='text-black text-5xl text-wrap font-medium font-vidaloka pb-8'>Lets make a change together!</p>
