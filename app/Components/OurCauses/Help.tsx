...
const Help = () => {
  return (
    <div className="h-[700px]  relative mx-auto flex flex-col text-white bg-cover bg-center bg-help-us justify-center items-center py-32">
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-black bg-opacity-60 z-0"></div>

      <div className='flex flex-col w-[1100px] text-center gap-3 justify-center items-center z-10'>
        <h1 className='font-vidaloka text-5xl'>
          Help Our Cause
        </h1>
